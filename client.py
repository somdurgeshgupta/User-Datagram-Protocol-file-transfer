...
time.sleep(1)
print()
print("\t\tWelcome to the Atharva/0.1 UDP File Transfer Client...")
time.sleep(0.2)
print('''
                              Atharva/0.1
...
def getserverIp():
    ...
    time.sleep(0.5)
    global serverIp
    serverIp = input("Atharva-Udp server-ip> ")
getserverIp()
...
def options():
    ...
    while True:
        ...
        time.sleep(0.5)
        command = input("Atharva-Udp > ")
        if command == "listf":
            requestList()
        elif command == "close":
            closeApp()
        else:
            print("Atharva-Udp > Command Error")
            continue
...
def closeApp():
    ...
    time.sleep(0.5)
    os.system('cls' if os.name == 'nt' else 'clear')
    print("Atharva-Udp is going to close...")
